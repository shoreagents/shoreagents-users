    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          side === "left"
            ? state === "expanded" ? "left-0" : "left-0"
            : state === "expanded" ? "right-0" : "right-0",
          side === "left"
            ? collapsible === "offcanvas" && state === "collapsed" ? "-left-64" : "left-0"
            : collapsible === "offcanvas" && state === "collapsed" ? "-right-64" : "right-0",
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-hidden ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
    />
