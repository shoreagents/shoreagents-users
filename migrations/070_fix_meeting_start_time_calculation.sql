-- Migration 070: Fix meeting start time calculation
-- This migration fixes the start_meeting function to use actual start time for accurate duration calculation
