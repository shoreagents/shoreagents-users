-- Complete cleanup of all duplicate functions
-- This will remove ALL instances and recreate them fresh

-- Drop ALL instances of these functions
...
DROP FUNCTION IF EXISTS calculate_break_windows(INTEGER) CASCADE;
...
COMMENT ON FUNCTION calculate_break_windows(INTEGER) IS 'Calculates break windows based on agent shift times (clean version)';
