-- Pre-create next-day activity_data rows at shift end (Manila time)
-- Inserts zeroed rows for the next effective date, per agent, once their shift has ended
...
BEGIN
    FOR rec IN (
        ...
        -- Parse times like "6:00 AM - 3:00 PM"
