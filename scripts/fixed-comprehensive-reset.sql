-- Fixed Comprehensive Activity Reset Function
-- This function properly handles date calculations and timezone issues

CREATE OR REPLACE FUNCTION public.fixed_comprehensive_activity_reset(
